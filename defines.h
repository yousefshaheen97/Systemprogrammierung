...
#define HEAPOFFSET 4000 


// intheap werte

#define HEAP_TOTAL_SIZE  (AVR_MEMORY_SRAM / 2 - HEAPOFFSET)


#define HEAP_MAP_SIZE    (HEAP_TOTAL_SIZE / 3)

#define HEAP_USE_SIZE     (HEAP_MAP_SIZE * 2)


#define HEAP_MAP_START   (AVR_SRAM_START + HEAPOFFSET)


#define HEAP_USE_START   (HEAP_MAP_START + HEAP_MAP_SIZE)


// esxtheap werte
#define EXTHEAP_TOTAL_SIZE  ((uint16_t)65535)
#define EXTHEAP_MAP_SIZE    (EXTHEAP_TOTAL_SIZE / 3)
#define EXTHEAP_USE_SIZE    (EXTHEAP_MAP_SIZE * 2)
#define EXTHEAP_MAP_START   (0x0)
#define EXTHEAP_USE_START   (EXTHEAP_MAP_START + EXTHEAP_MAP_SIZE)
